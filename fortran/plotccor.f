...
c      do iw=1,6
      ...
      do il=1,10000
         ...
         if(ntot.eq.1) then
            read(2,*) a1,i1,i2,i3,i4,i5,i6,i7
         else
            read(2,*)
         endif
         read(2,*) x0,x1,x2,x3,x4,x5,x6,x7
         xw(1)=x1/xn1
         xw(2)=x2/xn2
         xw(3)=x3/xn3
         xw(4)=x4/xn4
...
c         scale=1.
         n=0
         do i=1,nmax
            read(2,*,end=667) x0,x1,x2,x3,x4,x5,x6,x7
            n=n+1
            x(n)=x0/scale
            xf(1)=x1/xnb1
            xf(2)=x2/xnb2
...
c      write(*,1006) 0.5,(xin(i),i=1,7)
 1006 format(1x,f6.4,7(2x,f7.4))
      ...
      write(11,1101) 0.5,(xin(i),i=1,7)
      write(12,1102) i0,i1,i2,i3,i4,i5,i6,i7
      write(12,1101) 0.5,(xin(i),i=1,7)
c      write(11,1101) 0.5,xn1,xn2,xn3,xn4,xn5,xn6,xn7
      do i=1,ns
         write(11,1101) xs(i),(ysa(iw,i),iw=1,7)
         write(12,1101) xs(i),(ysae(iw,i),iw=1,7)
      enddo
      close(11)
      close(12)
