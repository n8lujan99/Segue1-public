...
c      call ftgkns(im1,'TTYPE',1,3,ttype,nfound,ier)
      ...
      do i=1,4000
         call ftgcvs(im1,1,i,1,1,nullstr,c1,anyf,ier)
c         call ftgcvj(im1,2,i,1,1,0.,j1,anyf,ier)
         call ftgcve(im1,2,i,1,1,0.,ra,anyf,ier)
         call ftgcve(im1,3,i,1,1,0.,dec,anyf,ier)
         call ftgcve(im1,8,i,1,1,0.,flux,anyf,ier)
         if(ier.ne.0) goto 706
         print *,i,c1,ra,dec,flux,ier
         write(11,*) c1,ra,dec,flux
      enddo
      close(11)
 706  continue
